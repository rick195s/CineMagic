    ...
    <form method="POST" class="sign__form" action="{{ route('register') }}">
        ...
        <div class="sign__group">
            <input id="name" placeholder="{{ __('Name') }}" type="text"
                class="sign__input form-control @error('name') is-invalid @enderror" name="name"
        ...
        <div class="sign__group">
            <input id="email" placeholder="{{ __('Email') }}" type="email"
                class="sign__input form-control @error('email') is-invalid @enderror" name="email"
        ...
        <div class="sign__group">
            <input id="password" placeholder="{{ __('Password') }}" type="password"
                class="sign__input form-control @error('password') is-invalid @enderror" name="password" required
        ...
        <span class="sign__text">{{ __('Already have an account?') }} <a
