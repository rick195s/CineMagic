<div class="row mb-3">
    ...
    <div class="col-md-6">
        <input id="titulo" value="{{old('titulo', $filme->titulo)}}" type="text" class="form-control @error('titulo') is-invalid @enderror" name="titulo" required>
...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        <input id="ano" value="{{old('ano', $filme->ano)}}" type="number" class="form-control @error('ano') is-invalid @enderror" name="ano" required>
