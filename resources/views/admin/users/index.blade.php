                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.users.edit', $user->id)}}" class="btn btn-info"><i data-feather="edit"></i> </a>
                                @endcan

                                @can('delete', $user)

                                <button form="delete_user_{{$user->id}}" class="btn btn-danger"><i data-feather="trash-2"></i> </button>
