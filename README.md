...
- [x] Os administradores podem gerir filmes, sessoes e outros valores que estao no enunciado.
...
- [x] As sessoes so podem ser alteradas ou removidas se ainda nao tiverem nenhum bilhete associado;
